...
Namespace Clientes_ProductosDataSetTableAdapters
    ...
    Partial Public Class ProductosTableAdapter
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As Clientes_ProductosDataSet.ProductosDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As Clientes_ProductosDataSet.ProductosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
